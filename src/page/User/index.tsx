...
export default function User() {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-zinc-100 dark:bg-zinc-900/95">
      ...
      <div className="relative z-10 flex h-full min-h-0 w-full flex-col">
        <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden px-12 pt-14 pb-14">
          <div className="space-y-10 max-w-[85vw] mx-auto">
