  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Header */}
        <div className="px-10 py-7 border-b border-zinc-100 flex justify-between items-center bg-emerald-50/30">
          <div className="flex items-center gap-5">
            <div className="p-4 bg-emerald-500/10 rounded-2xl">
              <Settings2 className="w-8 h-8 text-emerald-600" />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-zinc-900 tracking-tight"><Trans>连携程序管理</Trans></h2>
              <p className="text-zinc-500 text-sm font-medium"><Trans>配置随游戏或程序自动启动的辅助工具</Trans></p>
            </div>
          </div>
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto px-10 py-8 space-y-6 bg-white" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          {isLoading ? (
            ...
            <>
              {localCompanions.map((item, index) => (
                <div key={index} className={cn(
                  ...
                  item.isEnabled
                    ? "bg-zinc-50/30 border-zinc-100 hover:border-emerald-200 hover:bg-white hover:shadow-xl hover:shadow-emerald-500/5"
                  ...
                  <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6 mb-8">
                    <div className="flex items-center gap-4 flex-1">
                      ...
                      <input
                        className="text-2xl font-black text-zinc-900 bg-transparent outline-none border-b-2 border-transparent focus:border-emerald-500 transition-all flex-1 py-1"
                        value={item.name}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    <div className="md:col-span-12 space-y-2">
                      ...
                      <div className="relative group/path">
                        <input
                          ...
                          className="w-full bg-white border border-zinc-200 rounded-2xl px-5 py-4 text-zinc-800 font-bold text-sm cursor-pointer hover:border-emerald-400 transition-all outline-none pr-32"
                          value={item.path}
                    ...
                    <div className="md:col-span-9 space-y-2">
                      ...
                      <input
                        className="w-full border border-zinc-200 rounded-2xl px-5 py-4 text-zinc-800 text-sm font-bold focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/5 bg-white outline-none transition-all shadow-sm"
                        value={item.args}
                    ...
                    <div className="md:col-span-3 space-y-2">
                      <label className="text-zinc-400 font-bold text-[10px] uppercase ml-1 tracking-widest text-center block w-full"><Trans>排序权重</Trans></label>
                      <div className="relative flex items-center">
                        <input
                          type="number"
                          className="w-full border border-zinc-200 rounded-2xl px-5 py-4 text-zinc-800 text-sm font-bold focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/5 bg-white outline-none transition-all shadow-sm text-center appearance-none"
              ...
              <button
                ...
                className="w-full py-12 border-2 border-dashed border-zinc-200 rounded-[2rem] text-zinc-400 hover:text-emerald-600 hover:bg-emerald-50/50 hover:border-emerald-500 transition-all flex flex-col items-center justify-center gap-3 bg-zinc-50/30"
              >
                <div className="w-14 h-14 bg-white border border-zinc-100 rounded-full flex items-center justify-center group-hover:scale-110 transition-all duration-300">
        ...
        {/* Footer */}
        <div className="px-10 py-7 border-t border-zinc-100 bg-zinc-50/50 flex justify-end items-center gap-6">
          <button onClick={onClose} className="text-zinc-400 hover:text-zinc-900 font-bold transition-colors">
            <Trans>放弃修改</Trans>
          </button>
          <button
